...
public class pedra_Papel_tesoura extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbUsuario.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        cbUsuario.setForeground(new java.awt.Color(0, 51, 204));
        cbUsuario.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione", "Pedra", "Papel", "Tesoura" }));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(31, 31, 31)
                        .addComponent(btnJogar))
                    .addComponent(lblTelaResultado, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void btnJogarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnJogarActionPerformed
        ...
        int somaD=Integer.parseInt(lblContD.getText());
        int somaV=Integer.parseInt(lblContV.getText());
        int cont;

        switch(aleatorio){
            case 0:
                lblPpt.setText("Pedra");
                break;
            case 1:
                lblPpt.setText("Papel");
                break;
            case 2:
                lblPpt.setText("Tesoura");
                break;
            default:
                break;
        }
        if(cbUsuario.getSelectedItem().equals("Pedra")&&lblPpt.equals("Papel")){
            lblTelaResultado.setText("Você Perdeu!");
        }else if(cbUsuario.getSelectedItem().equals("Papel")&&lblPpt.equals("Tesoura")){
            lblTelaResultado.setText("Você Perdeu!");
        }else if(cbUsuario.getSelectedItem().equals("Tesoura")&&lblPpt.equals("Pedra")){
            lblTelaResultado.setText("Você Perdeu!");
        }else if(cbUsuario.getSelectedItem().equals("Pedra")&&lblPpt.equals("Tesoura")){
            lblTelaResultado.setText("Você Ganhou!");
        }else if(cbUsuario.getSelectedItem().equals("Papel")&&lblPpt.equals("Pedra")){
            lblTelaResultado.setText("Você Ganhou!");
        }else if(cbUsuario.getSelectedItem().equals("Tesoura")&&lblPpt.equals("Papel")){
            lblTelaResultado.setText("Você Ganhou!");
        }
        if(lblTelaResultado.getText().equals("Você Ganhou!")){
            cont=somaV+1;
            lblContV.setText(""+cont);
        }else{
            cont=somaD+1;
            lblContD.setText(""+cont);
        }
